 ...
 * Author: Given
 * 
 * An object to store a row, col, and type
 */
...
public class Cell {
    ...
    /**
     * Specifies the CellType of this Cell (either FREE, OBSTACLE, MUD, ICE)
     */
    private CellType type;

    /**
     * A counter for whether or not the mud has been traversed (EXTENSION ONLY)
     */
    private boolean mud;
     ...
     * @param type the CellType of the Cell (either FREE, OBSTACLE, MUD, ICE)
     */
     ...
     */
    public void setMudToggle(boolean toggle) {
        this.mud = toggle;
    }
