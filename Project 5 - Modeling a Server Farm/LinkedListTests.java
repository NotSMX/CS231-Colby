...
public class LinkedListTests {
    ...
    public static void main(String[] args) {
        ...
        // case 12: testing offer(), poll() and peek()
        {
            // setup
            ...
            // test
            assert q.size() == 3 : "Error in LinkedList::offer()";
            assert q.peek() == 1 : "Error in LinkedList::offer() or LinkedList::peek()";
            assert q.poll() == 1 : "Error in LinkedList::poll()";
            assert q.poll() == 2 : "Error in LinkedList::poll()";
        }
