 ...
 * @author bseastwo
 */
public class LandscapeDisplayFlex {
    JFrame win;
    protected BoardFlex scape;
     ...
     */
    public LandscapeDisplayFlex(BoardFlex scape) {
        // setup the window
        ...
        this.canvas = new LandscapePanel(scape.SIZE * this.gridScale, (scape.SIZE + 2) * this.gridScale);
