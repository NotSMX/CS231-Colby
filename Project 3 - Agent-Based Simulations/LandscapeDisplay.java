...
* Author: Daniel Yu
* 
* To display and initiate the simulation of Landscape
*/
...
public class LandscapeDisplay {
    ...
    public static void main(String[] args) throws InterruptedException {
        Landscape scape = new Landscape(1000, 1000);
        ...
        for (int i = 0; i < 100; i++) {
            ...
            scape.addAgent(new AntiSocialAgent(gen.nextDouble() * scape.getWidth(),
                    gen.nextDouble() * scape.getHeight(),
                    50));
            scape.addAgent(new EnemyAgent(gen.nextDouble() * scape.getWidth(),
                    gen.nextDouble() * scape.getHeight(),
                    10));
            scape.addAgent(new SquadAgent(gen.nextDouble() * scape.getWidth(),
                    gen.nextDouble() * scape.getHeight(),
                    10));
        }
